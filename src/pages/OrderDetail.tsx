          ...
          <CardContent>
            <form className="space-y-4">
              ...
              <div>
                ...
                <input type="text" className="w-full rounded border p-2" placeholder="Products Ordered" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1">Shipping Address</label>
                <input type="text" className="w-full rounded border p-2" placeholder="Shipping Address" />
              </div>
              <div>
